...
//
//
        var $112517 = exports.default || module.exports;
      
      if (typeof $112517 === 'function') {
        $112517 = $112517.options;
      }
    
        /* template */
        Object.assign($112517, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$112517', $112517);
          } else {
            api.reload('$112517', $112517);
          }
        }
...
},{"../svg":"svg.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/button.vue":[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  props: {
    ...
    loading: {
      ...
      default: false
        ...
        var $3e3b16 = exports.default || module.exports;
      
      if (typeof $3e3b16 === 'function') {
        $3e3b16 = $3e3b16.options;
      }
  ...
  return _c(
    ...
    [
      _vm.name && !_vm.loading
        ? _c("g-icon", { staticClass: "icon", attrs: { name: _vm.name } })
        : _vm._e(),
      _vm._v(" "),
      _vm.loading
        ? _c("g-icon", {
            class: { spin: true, icon: true },
            attrs: { name: "loading" }
          })
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "wrap-slot" }, [_vm._t("default")], 2)
    ],
    1
  )
  var _obj
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3e3b16', $3e3b16);
          } else {
            api.reload('$3e3b16', $3e3b16);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.common.js","./icon":"src/icon.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"src/groupBtn.vue":[function(require,module,exports) {
'use strict';
  ...
  mounted: function mounted() {
    ...
    try {
      ...
      try {
        ...
        var $cfef77 = exports.default || module.exports;
      
      if (typeof $cfef77 === 'function') {
        $cfef77 = $cfef77.options;
      }
    
        /* template */
        Object.assign($cfef77, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cfef77', $cfef77);
          } else {
            api.reload('$cfef77', $cfef77);
          }
        }
...
//
//
        var $71f87c = exports.default || module.exports;
      
      if (typeof $71f87c === 'function') {
        $71f87c = $71f87c.options;
      }
    
        /* template */
        Object.assign($71f87c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$71f87c', $71f87c);
          } else {
            api.reload('$71f87c', $71f87c);
          }
        }
  ...
  mounted: function mounted() {
    ...
    this.$children.forEach(function (vm) {
      vm.gutter = _this.gutter;
        ...
        var $6176b6 = exports.default || module.exports;
      
      if (typeof $6176b6 === 'function') {
        $6176b6 = $6176b6.options;
      }
    
        /* template */
        Object.assign($6176b6, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6176b6', $6176b6);
          } else {
            api.reload('$6176b6', $6176b6);
          }
        }
  ...
  data: function data() {
    return {
      gutter: 0
        ...
        var $403e2f = exports.default || module.exports;
      
      if (typeof $403e2f === 'function') {
        $403e2f = $403e2f.options;
      }
    
        /* template */
        Object.assign($403e2f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$403e2f', $403e2f);
          } else {
            api.reload('$403e2f', $403e2f);
          }
        }
...
exports.default = {};
      ...
      if (typeof $61cd38 === 'function') {
        $61cd38 = $61cd38.options;
      }
    
        /* template */
        Object.assign($61cd38, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$61cd38', $61cd38);
          } else {
            api.reload('$61cd38', $61cd38);
          }
        }
...
exports.default = {};
      ...
      if (typeof $82b29e === 'function') {
        $82b29e = $82b29e.options;
      }
    
        /* template */
        Object.assign($82b29e, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$82b29e', $82b29e);
          } else {
            api.reload('$82b29e', $82b29e);
          }
        }
...
exports.default = {};
      ...
      if (typeof $63521b === 'function') {
        $63521b = $63521b.options;
      }
    
        /* template */
        Object.assign($63521b, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$63521b', $63521b);
          } else {
            api.reload('$63521b', $63521b);
          }
        }
...
exports.default = {};
      ...
      if (typeof $0c06ae === 'function') {
        $0c06ae = $0c06ae.options;
      }
    
        /* template */
        Object.assign($0c06ae, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0c06ae', $0c06ae);
          } else {
            api.reload('$0c06ae', $0c06ae);
          }
        }
...
exports.default = {};
      ...
      if (typeof $ad1995 === 'function') {
        $ad1995 = $ad1995.options;
      }
    
        /* template */
        Object.assign($ad1995, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ad1995', $ad1995);
          } else {
            api.reload('$ad1995', $ad1995);
          }
        }
...
exports.default = {
  ...
  return _c(
    "div",
    {
      ref: "toast",
      staticClass: "toast",
      class: ["position-" + _vm.toastPosition]
    },
    [
...
var _groupBtn = require('./groupBtn');

var _groupBtn2 = _interopRequireDefault(_groupBtn);
...
var _tabsHead = require('./tabsHead');
...
var _tabsBody = require('./tabsBody');
...
_vue2.default.component('g-tab-head', _tabsHead2.default);
_vue2.default.component('g-tab-item', _tabsItem2.default);
_vue2.default.component('g-tab-panel', _tabsPanel2.default);
_vue2.default.component('g-tab-body', _tabsBody2.default);

_vue2.default.component('g-button', _button2.default);
_vue2.default.component('g-icon', _icon2.default);
_vue2.default.component('group-btn', _groupBtn2.default);
...
{
  /* 如何实例化一个对象 */
  var cons = _vue2.default.extend(_button2.default);
  var btn = new cons({
    propsData: {
      name: 'xia'
    }
  ...
  btn.$mount('#test');
  var useEl = btn.$el.querySelector('use');
...
{
  /* 测试按钮在左边 */
  var cons1 = _vue2.default.extend(_button2.default);
  ...
  btn1.$mount(el);
  var svgEl = btn1.$el.querySelector('svg');

  var _getComputedStyle = getComputedStyle(svgEl),
      order = _getComputedStyle.order;
...
{
  /* 测试按钮在右边 */
  var _cons = _vue2.default.extend(_button2.default);
  ...
  _btn.$mount(_el);
  var _svgEl = _btn.$el.querySelector('svg');

  var _getComputedStyle2 = getComputedStyle(_svgEl),
      _order = _getComputedStyle2.order;
...

{
  var should = _chai2.default.should(),
      _expect = _chai2.default.expect;

  var _btn2 = _vue2.default.extend(_button2.default);
  var _cons2 = new _btn2({
    propsData: {
      name: 'xia'
    }
  }).$mount();
  ...
  ee.click();
  _expect(spy).to.have.been.called();
}

{
  ...
  var _btn3 = _vue2.default.extend(_button2.default);
  var _cons3 = new _btn3({
    propsData: {
      name: 'loading',
      loading: true
    }
  ...
  // btn.$mount(el);
  var _useEl = _cons3.$el.querySelector('use');
  expect(_useEl.getAttribute('xlink:href')).to.equal('#i-loading');

  _cons3.$el.remove();
  _cons3.$destroy();
}
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","./icon":"src/icon.vue","./groupBtn":"src/groupBtn.vue","./Input":"src/Input.vue","./row":"src/row.vue","./col":"src/col.vue","./layout":"src/layout.vue","./header":"src/header.vue","./content":"src/content.vue","./footer":"src/footer.vue","./sider":"src/sider.vue","./tabs":"src/tabs.vue","./tabsHead":"src/tabsHead.vue","./tabsItem":"src/tabsItem.vue","./tabsPanel":"src/tabsPanel.vue","./tabsBody":"src/tabsBody.vue","./plugin":"src/plugin.js","chai":"node_modules/chai/index.js","chai-spies":"node_modules/chai-spies/chai-spies.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/app.2824255b.map